...
//===== By: ==================================================
//= Originally By AnnieRuru
//= Modifed by Dastgir[Hercules]
//===== Current Version: =====================================
//= 1.3
//===== Compatible With: ===================================== 
//= Hercules 2017-06-21
...
{
	if (strcmpi(key, "battle_configuration/max_blv_exp_gain") == 0)
		max_blv_exp_gain = atoi(val);
	else if (strcmpi(key, "battle_configuration/max_jlv_exp_gain") == 0)
...
int return_battle_config( const char *key )
{
	...
	else if (strcmpi(key, "max_jlv_exp_gain") == 0)
